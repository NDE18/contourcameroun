...
class UploadHandler {
    ...
    public $chunksFolder = '../../../images/upload';
    ...
    $statutFileCreation=createFile("image","a","json");
    ...
    public function getName(){
        ...
        if (isset($_FILES[$this->inputName]))
            $image = array('image' => $_FILES[$this->inputName]['name'] );
            if($statutFileCreation['statut']==true) writeInFile($statutFileCreation['name'],json_encode($image,JSON_FORCE_OBJECT,JSON_PRETTY_PRINT)); 
