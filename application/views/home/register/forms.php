      ...
      function script(){
        ...
        element.classList.add("active");
                        ...
                        <div class="form-group form-input col-md-6">
                            <label class="control-label" for="login-username">Titre</label>
                                <select class="form-control form-validation-inside select-width" id="titre" type="select" name="titre">
                                    <option selected disabled value="11">Selectionnez votre titre</option>
                                    <option value ="MmeMs">MmeMs </option >
                        ...
                        <div class="form-group form-input inputWithIcon inputIconBg col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <label class="control-label" for="login-pass">Lieu d'affection</label>
                            <div class="inputWithIcon inputIconBg">
                              <input class="form-control" id="affectation" type="select" name="affectation" data-constraints="@Required">
                              <i class="fa fa-edit fa-lg fa-fw" aria-hidden="true"></i>
                            </div>
                            <span id="error_affectation" class="text-danger"></span>
                            <?php echo form_error('affectation')?>
                        </div-->
                        <div class="form-group form-input inputWithIcon inputIconBg col-md-6">
                            <input id="speudo" type="text" name="speudo"/>
                            <i class="fa fa-user fa-lg fa-fw" aria-hidden="true"></i>
                            <label class="form-label" for="speudo">Speudo</label>
                            <span id="error_speudo" class="text-danger"></span>
                            <?php echo form_error('speudo')?>
                        </div>
                        <div class="form-group form-input inputWithIcon inputIconBg col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <label class="form-label" for="login-pass">Image</label>
                            <div id="file-drop-area"></div>
                        </div>