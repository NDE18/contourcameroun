    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
          ...
          <span class="logo-mini"><b>B</b>2K</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>B2K</b>TECH</span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              ...
              <a href="<?= base_url('admin/trajets'); ?>">
                <i class="fa fa-th"></i> <span>Trajets</span>
              </a>
            </li>
						<li>
            ...
            <li>
              <a href="<?= base_url('admin/voitures'); ?>">
                <i class="fa fa-th"></i> <span>Voitures</span>
              </a>
            </li>
           
            <li>
              <a href="<?= base_url('admin/paiements'); ?>">
                <i class="fa fa-th"></i> <span>Paiements</span>
              </a>
            </li>
